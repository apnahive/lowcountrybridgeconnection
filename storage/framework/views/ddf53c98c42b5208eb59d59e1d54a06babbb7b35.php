...
<div class="container" style="margin-top: 60px;">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1"> <a href="<?php echo e(URL::previous()); ?>"><button type="button" class="btn btn-lg btn-info">Back</button></a>           
            <a href="<?php echo e(route('unitadmin.create1')); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add a New Manager</button></a>
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <div class="col-md-3 wcol-md-3" style="text-align: center">
                            <div class="col-md-6"><a href="<?php echo e(route('unitmanager.edit', $value->id)); ?>"><button type="button" class="btn btn-priamry">Edit</button></a></div> 
                            ...
                            <form id="<?php echo e($value->id); ?>" action="/unitmanager/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
