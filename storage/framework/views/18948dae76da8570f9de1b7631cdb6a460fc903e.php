        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">            
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('superclass.store')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('class_description') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <textarea id="class_description" type="text" class="form-control" name="class_description" value="<?php echo e(old('class_description')); ?>" placeholder="maximum 255 character" required autofocus></textarea>
