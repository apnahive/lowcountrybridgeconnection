        ...
        <nav class="navbar navbar-default navbar-static-top navbar-custom" style="padding-bottom: 0px;padding-top: 0px;">
            <div class="container containmenu">
                <div class="navbar-header">
                    ...
                    <!-- Branding Image -->
                    <a class="fa fa-home navbar-brand" href="<?php echo e(url('/manager')); ?>">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                            <ul class="nav navbar-nav navbar-right dropmenu" style="border: 2px white solid;border-bottom-width: 0;border-top-width: 0;">
                                ...
                                <li class="page-scroll">
                                        ...
                                        <ul class="dropdown-menu menudrop1">
                                          <li><a href="<?php echo e(route('tournament.index')); ?>">Manage Tournaments</a></li>
                                          <li><a href="<?php echo e(route('special_game.index')); ?>">Manage Special Games</a></li>
                                          <li><a href="<?php echo e(route('games.index')); ?>">Manage Games</a></li>
                                        </ul>
                                    
                                </li>
                                <li class="page-scroll">
                                    <a href="<?php echo e(route('playergame.index')); ?>">Manage Enrollments</a>
                                </li>
                                <li class="page-scroll">
                                    <a href="<?php echo e(route('playermanager.index')); ?>">Manage Players</a>
                                </li>
                                <li class="page-scroll">
                            ...
                            <ul class="nav navbar-nav navbar-right mobile" style="border: 2px white solid;border-bottom-width: 0;border-top-width: 0;">
                                <li class="page-scroll">
                                    <a href="<?php echo e(route('tournament.index')); ?>">Manage Tournaments</a>
                                </li>
                                <li class="page-scroll">
                                    <a href="<?php echo e(route('special_game.index')); ?>">Manage Special Games</a>
                                </li>
                                <li class="page-scroll">
                                    <a href="<?php echo e(route('games.index')); ?>">Manage Games</a>
                                </li>                                
                                <li class="page-scroll">
                                    <a href="<?php echo e(route('playergame.index')); ?>">Manage Enrollments</a>
                                </li>
