...
<div class="container" style="margin-top: 60px;">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1"> <a href="<?php echo e(URL::previous()); ?>"><button type="button" class="btn btn-lg btn-info">Back</button></a>           
            <a href="<?php echo e(route('supermanager.create')); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add a New Manager</button></a>
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <hr class="mobline">
                    <?php $__currentLoopData = $manager; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $managerkey => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <div class="col-md-3 wcol-md-3" style="word-wrap: break-word;"><?php echo e($value->email); ?></div>
                        <div class="col-md-3 wcol-md-3">
                            <?php $__currentLoopData = $clubs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clubkey => $club): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($club->id == $value->club_id): ?>
                                    <?php echo e($club->club_name); ?> 
                                <?php endif; ?>    
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <div class="col-md-3 wcol-md-3" style="text-align: center">
                            <div class="col-md-6"><a href="<?php echo e(route('supermanager.edit', $value->id)); ?>"><button type="button" class="btn btn-priamry">Edit</button></a></div> 
                            ...
                            <form id="<?php echo e($value->id); ?>" action="/supermanager/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
