...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <div class="col-md-5 wcol-md-5" style="text-align: center">
                            <div class="col-md-4"><a href="<?php echo e(route('unitgame.show', $value->id)); ?>"><button type="button" class="btn btn-priamry">View</button></a></div>
                            <div class="col-md-4 button-top"><?php if($value->game_status == 1): ?><a href="<?php echo e(route('unitgame.edit', $value->id)); ?>"><button type="button" class="btn btn-priamry">Edit</button></a><?php endif; ?></div>  
                            ...
                            <form id="<?php echo e($value->id); ?>" action="/unitsgame/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
            ...
            <!-- <a href="<?php echo e(route('game-files',['type'=>'xls'])); ?>" class="pull-right" style="margin-bottom: 30px;">
