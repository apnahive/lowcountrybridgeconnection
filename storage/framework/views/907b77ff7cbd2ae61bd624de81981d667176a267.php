...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <form id="<?php echo e($classes->id); ?>" action="/unitclass_subscriptionss/delete/<?php echo e($classes->id); ?>" method="DELETE" style="display: none;">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body" style="font-size: 19px;">               
                    ...
                    <div class="row" style="margin-bottom: 10px;display: flex;">
                        <div class="col-md-4 wcol-md-4 showdata" style="word-wrap: break-word;">Teacher Name</div>
                        <div class="col-md-6 wcol-md-6"><?php echo e($classes->teacher); ?></div>
                    </div>
                    <div class="row" style="margin-bottom: 10px;display: flex;">
            ...
            <?php if($classes->class_status == 1): ?><a href="<?php echo e(route('unitclass.edit', $classes->id)); ?>"><button type="button" class="btn btn-lg btn-info">Edit</button></a><?php endif; ?>
            <div class="pull-right">
            <a href="<?php echo e(route('unitclasswaiting.show', $classes->id)); ?>"><button type="button" class="btn btn-lg btn-info">Waiting List</button></a>
                <a href="<?php echo e(route('unitclass_subscription.index')); ?>"><button type="button" class="btn btn-lg btn-info">Manage Enrollments </button></a>                
            </div>
        </div>
    </div>
</div>
