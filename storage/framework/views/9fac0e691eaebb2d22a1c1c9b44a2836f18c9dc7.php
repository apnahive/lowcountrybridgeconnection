...
<div class="container" style="margin-top: 60px;margin-bottom: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="col-md-5"><a href="<?php echo e(route('member.create')); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add New Registered User</button></a></div>
            </div>                       
