  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?php echo e(route('unitclass.creates', Session::get('error_code') )); ?>"><button type="button" class="btn btn-primary">Yes</button></a>
...
<div class="container" style="margin-top: 60px;">    
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <a href="<?php echo e(route('unitseries.create')); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add a New Series</button></a>
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <!-- <div class="col-md-3"></div> -->
                        <div class="col-md-8 wcol-md-8" style="text-align: center;">
                            <div class="col-md-3"><a href="<?php echo e(route('unitseries_class.edit', $value->id)); ?>"><button type="button" class="btn btn-priamry">Classes</button></a></div>
                            <div class="col-md-3 button-top"><a href="<?php echo e(route('unitseries.show', $value->id)); ?>"><button type="button" class="btn btn-priamry">Classes</button></a></div>
                            <div class="col-md-3 button-top"><a href="<?php echo e(route('unitseries.edit', $value->id)); ?>"><button type="button" class="btn btn-priamry">Edit</button></a></div>
                            ...
                            <form id="<?php echo e($value->id); ?>" action="/unitseriess/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
