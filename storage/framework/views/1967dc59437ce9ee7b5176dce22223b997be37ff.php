        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">            
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('unitgame.store')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('game_name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="game_name" type="text" class="form-control" name="game_name" value="<?php echo e(old('game_name')); ?>" placeholder="maximum 20 character" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('game_description') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <textarea id="game_description" type="text" class="form-control" name="game_description" value="<?php echo e(old('game_description')); ?>" placeholder="maximum 255 character" required autofocus></textarea>
                                    ...
                                    <select class="custom-select form-control" id="manager_name" name="manager_name">
                                      <option selected>Choose...</option>
                                        <?php $__currentLoopData = $managers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                            <option value="<?php echo e($manager->id); ?>"><?php echo e($manager->name); ?> --
                        ...
                        <div class="form-group<?php echo e($errors->has('game_date') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="game_date" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" name="game_date" value="<?php echo e(old('game_date')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('max_enroll') ? ' has-error' : ''); ?>">
                            <label for="max_enroll" class="col-md-4 control-label">Maximum Enrollment</label>

                            <div class="col-md-6">
                                <input id="max_enroll" type="text" class="form-control" name="max_enroll" value="<?php echo e(old('max_enroll')); ?>" required autofocus>

                                <?php if($errors->has('max_enroll')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('max_enroll')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>                       
