...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <a href="<?php echo e(route('unitgame.show', $id)); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">View Game</button></a>
           <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <hr class="mobline">
                    <?php $__currentLoopData = $game_sub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gamesubkey => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($value->game_id == $gameid): ?>
                                    ...
                                    <?php if($value->user_id == $user->id): ?>     
                                        <div class="row" style="margin-top: 15px;display: flex;">
                                            ...
                                            <div class="col-md-4 wcol-md-4" style="text-align: center">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="button-top"><button type="button" class="btn btn-priamry" data-toggle="modal" data-target="#confirm<?php echo e($value->id); ?>">Cancel</button></div>

                                                    <form id="<?php echo e($value->id); ?>" action="/unitgame_cancel_enrollment/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
