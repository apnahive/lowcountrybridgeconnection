...
<div class="container" style="margin-top: 60px;margin-bottom: 60px;">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <!-- <div class="row">
            <div class="col-md-2"><a href="<?php echo e(route('superadmins.index')); ?>"><button type="button" class="btn btn-lg btn-info">Back</button></a></div>
            <div class="col-md-6"> 
            <form action="<?php echo route('superplayers.search'); ?>" method="POST" role="search">
                <?php echo e(csrf_field()); ?>
            ...
            <div class="col-md-4"><a href="<?php echo e(route('superplayers.create')); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add New Unregistered User</button></a></div>
            </div>  -->                      
            ...
            <a href="<?php echo e(route('superplayers.show', 'upload-record')); ?>" class="pull-right" style="margin-bottom: 30px;">
