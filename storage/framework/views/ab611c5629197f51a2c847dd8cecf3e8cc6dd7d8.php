                ...
                <div class="panel-body">
                              ...
                              <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
                                <div class="bhoechie-tab-content active">
                                  <div class="row">
                                     <div class="col-md-12">
                                        <!-- add form here -->
                                        <form class="form-horizontal" role="form" method="POST" action="<?php echo route('unitclass_subscription.update', $players['id']); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <label for="class_name" class="control-label"> <?php echo e($players->name); ?> </label>
                                                <label for="class_name" class="control-label"> <?php echo e($players->lastname); ?> </label>
                                            </div>
                                        </div>
                    ...
                    <!-- <form class="form-horizontal" role="form" method="POST" action="<?php echo route('unitclass_subscription.update', $players['id']); ?>">
                        ...
                        <div class="form-group">
                            <label for="player_name" class="col-md-4 control-label">Player Name</label>
                            <div class="col-md-6">
                                <label for="class_name" class="control-label"> <?php echo e($players->firstname); ?> </label>
                                <label for="class_name" class="control-label"> <?php echo e($players->lastname); ?> </label>
                            </div>
                        </div>
