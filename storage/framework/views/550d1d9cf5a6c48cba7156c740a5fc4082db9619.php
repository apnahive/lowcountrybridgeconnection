        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('unitseries.store')); ?>"  enctype="multipart/form-data">
                        ...
                        <div class="form-group<?php echo e($errors->has('series_name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="series_name" type="text" class="form-control" name="series_name" value="<?php echo e(old('series_name')); ?>" placeholder="maximum 20 character" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control" name="description" value="<?php echo e(old('description')); ?>" placeholder="maximum 255 character" required autofocus></textarea>
                        ...
                        <div class="form-group<?php echo e($errors->has('end_date') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="end_date" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" name="end_date" value="<?php echo e(old('end_date')); ?>">
