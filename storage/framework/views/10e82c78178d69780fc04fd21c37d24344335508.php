...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <a href="<?php echo e(route('supertournament.create')); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add a New Tournament</button></a>
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <div class="col-md-1 wcol-md-1"></div>
                        <div class="col-md-5 wcol-md-5" style="text-align: center">
                            <div class="col-md-4"><a href="<?php echo e(route('supertournament.edit', $value->id)); ?>"><button type="button" class="btn btn-priamry">Edit</button></a></div> 
                            <div class="col-md-4 button-top"><a href="<?php echo e(route('supertournament.show', $value->id)); ?>"><button type="button" class="btn btn-priamry">View</button></a></div>
                            ...
                            <form id="<?php echo e($value->id); ?>" action="/supertournament/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
