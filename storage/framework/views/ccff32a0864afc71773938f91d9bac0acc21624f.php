...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="col-md-12">
                <a href="<?php echo e(URL::previous()); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add student to class</button></a>
            </div>
                    ...
                    <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classkey => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                        <?php if($value->class_status): ?>
                            <div class="row" style="margin-top: 15px;display: flex;">
                                ...
                                <div class="col-md-5 wcol-md-5" style="text-align: center">                           
                                    <div class="col-md-6"><a href="<?php echo e(route('superclass_subscription.show', $value->id)); ?>"><button type="button" class="btn btn-priamry">Enrollment</button></a></div>    
                                    <div class="col-md-6 button-top"><a href="<?php echo e(route('superclasswaiting.show', $value->id)); ?>"><button type="button" class="btn btn-priamry">Waitlist</button></a></div>  

                              <!--       <div class="col-md-4 button-top"><a href="/superclass_subscription/delete/<?php echo e($value->id); ?>"><button type="button" class="btn btn-priamry">Cancel</button></a></div> -->
