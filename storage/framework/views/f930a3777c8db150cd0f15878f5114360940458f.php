  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?php echo e(route('series_class.editc', Session::get('error_codes'))); ?>"><button type="button" class="btn btn-primary">Yes</button></a>
...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <div class="col-md-4 wcol-md-4">
                            ...
                            Status: <?php if($value->class_status == 0): ?> Cancelled <?php else: ?> Active <?php endif; ?>
                        </div>
                        <div class="col-md-5 wcol-md-5" style="text-align: center">
                            <div class="col-md-4 button-top"><a href="/classes/<?php echo e($value->id); ?>"><button type="button" class="btn btn-priamry">View</button></a></div>

                            <div class="col-md-4"><?php if($value->class_status == 1): ?><a href="<?php echo e(route('classes.edit', $value->id)); ?>"><button type="button" class="btn btn-priamry">Edit</button></a><?php endif; ?></div> 
                            ...
                            <form id="<?php echo e($value->id); ?>" action="/class/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
           ...
           <!--  <a href="<?php echo e(route('series.index')); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Manage Series</button></a> -->
        </div>
    </div>
</div>
<!-- Footer -->
