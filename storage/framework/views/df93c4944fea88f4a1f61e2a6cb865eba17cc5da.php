...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <form id="<?php echo e($classes->id); ?>" action="/superclass_subscription/delete/<?php echo e($classes->id); ?>" method="DELETE" style="display: none;">
            ...
            <?php if($classes->class_status == 1): ?><a href="<?php echo e(route('superclass.edit', $classes->id)); ?>"><button type="button" class="btn btn-lg btn-info">Edit</button></a>
            <div class="pull-right"><?php endif; ?>
                <a href="<?php echo e(route('superplayers.create')); ?>"><button type="button" class="btn btn-lg btn-info">Add Student</button></a>
                <a href="<?php echo e(route('superclass_subscription.index')); ?>"><button type="button" class="btn btn-lg btn-info">Manage Enrollment</button></a>                
            </div>
        </div>
    </div>
</div>
