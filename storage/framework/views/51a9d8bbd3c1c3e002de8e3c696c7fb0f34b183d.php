  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?php echo e(route('unitseries_class.editc', Session::get('error_codes'))); ?>"><button type="button" class="btn btn-primary">Yes</button></a>
...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <a href="/unitclass/create" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add a New Class</button></a>
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <div class="col-md-5 wcol-md-5" style="text-align: center">                            
                            <div class="col-md-4 button-top"><a href="/unitclass/<?php echo e($value->id); ?>"><button type="button" class="btn btn-priamry">View</button></a></div>
                            
                            <div class="col-md-4"><?php if($value->class_status == 1): ?><a href="<?php echo e(route('unitclass.edit', $value->id)); ?>"><button type="button" class="btn btn-priamry">Edit</button></a><?php endif; ?></div> 
                            ...
                            <form id="<?php echo e($value->id); ?>" action="/unitsclass/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
            ...
            <!-- <a href="<?php echo e(route('class-files',['type'=>'xls'])); ?>" class="pull-right" style="margin-bottom: 30px;">
