        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">            
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('unitclass.store')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('class_name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="class_name" type="text" class="form-control" name="class_name" value="<?php echo e(old('class_name')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('class_description') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <textarea id="class_description" type="text" class="form-control" name="class_description" value="<?php echo e(old('class_description')); ?>" required autofocus></textarea>
                                    ...
                                    <select class="custom-select form-control" id="teacher_name" name="teacher_name">
                                      <option selected>Choose...</option>
                                        <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                            <h1><option value="<?php echo e($teacher->id); ?>"><?php echo e($teacher->name); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('class_from') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="class_from" type="date" class="form-control" name="class_from" value="<?php echo e(old('class_from')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('class_till') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="class_till" type="date" class="form-control" name="class_till" value="<?php echo e(old('class_till')); ?>">
    ...
    <div class="modal-content" style="text-align: left;">
      ...
      <div class="modal-body">
        ...
        <div class="form-group<?php echo e($errors->has('end_date') ? ' has-error' : ''); ?>">
            ...
            <div class="col-md-6">
                <input id="end_date" type="date" class="form-control" name="end_date" value="<?php echo e(old('end_date')); ?>" required autofocus>
