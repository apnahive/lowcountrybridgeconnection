...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <a href="<?php echo e(route('classes.show', $id)); ?>" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">View Class</button></a>            
           ...
           <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    <div class="row" style="display: flex;">
                        ...
                        <div class="col-md-5 wcol-md-5">Student Name</div>
                        <div class="col-md-2 wcol-md-2"></div>
                                        ...
                                        <div class="row" style="margin-top: 15px;display: flex;">
                                            ...
                                            <div class="col-md-4 wcol-md-4" style="text-align: center">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form id="<?php echo e($value->id); ?>" action="/playerclass_cancel_enrollment/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
