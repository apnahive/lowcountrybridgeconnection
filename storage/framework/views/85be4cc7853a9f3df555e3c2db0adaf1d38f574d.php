                    ...
                    <?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gamekey => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($value->game_status): ?>
                            <div class="row" style="margin-top: 15px;display: flex;">
                                ...
                                <div class="col-md-5 wcol-md-5" style="text-align: center">                           
                                    <div class="col-md-6 button-top"><a href="<?php echo e(route('unitgame_subscription.show', $value->id)); ?>"><button type="button" class="btn btn-priamry">Enrollment</button></a></div>    
                                    

                                    <div class="col-md-6 button-top"><a href="<?php echo e(route('unitgamewaiting.show', $value->id)); ?>"><button type="button" class="btn btn-priamry">waitlist</button></a></div>
                                    ...
                                    <form id="<?php echo e($value->id); ?>" action="/unitgame_subscriptionss/delete/<?php echo e($value->id); ?>" method="DELETE" style="display: none;">
