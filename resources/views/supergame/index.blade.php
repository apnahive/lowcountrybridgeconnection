            ...
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <div class="col-md-5 wcol-md-5" style="text-align: center">
                            <div class="col-md-4"><a href="{{ route('supergame.show', $value->id) }}"><button type="button" class="btn btn-priamry">View</button></a></div>
                            <div class="col-md-4 button-top">@if($value->game_status == 1)<a href="{{ route('supergame.edit', $value->id) }}"><button type="button" class="btn btn-priamry">Edit</button></a>@endif</div> 
                            ...
                            <form id="{{$value->id}}" action="/supersgame/delete/{{$value->id}}" method="DELETE" style="display: none;">
