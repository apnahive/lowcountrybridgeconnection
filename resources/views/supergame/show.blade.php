...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <form id="{{$games->id}}" action="/supergame_subscription/delete/{{ $games->id }}" method="DELETE" style="display: none;">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body" style="font-size: 19px;">               
                    ...
                    <div class="row" style="margin-bottom: 10px;display: flex;">
                        ...
                        <div class="col-md-6 wcol-md-6"> {{ $games->club_name }} </div>
                    </div>
                    <div class="row" style="margin-bottom: 10px;display: flex;">
                    ...
                    <div class="row" style="margin-bottom: 10px;display: flex;">
                        ...
                        <div class="col-md-6 wcol-md-6">{{ $games->manager }}</div>
                    </div>
                    <div class="row" style="margin-bottom: 10px;display: flex;">
            ...
            @if($games->game_status == 1)<a href="{{ route('supergame.edit', $games->id) }}"><button type="button" class="btn btn-lg btn-info">Edit</button></a>@endif
            <div class="pull-right">
               <a href="{{ route('supergamewaiting.show', $games->id) }}"><button type="button" class="btn btn-lg btn-info">Waiting List</button></a>
