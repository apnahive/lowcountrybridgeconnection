...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <a href="{{ route('supergame.index') }}"><button type="button" class="btn btn-lg btn-info">Back</button></a>            
            <div class="panel panel-default" style="margin-top: 30px;">
                <div class="panel-heading">Edit Game</div>
                <div class="panel-body">
               
                     <form class="form-horizontal" role="form" method="POST" action="{!! route('supergame.update', $games['id']) !!}">
                                ...
                                <div class="form-group" style="margin: 0;">                                    
                                    <select class="custom-select form-control" id="manager_name" name="manager_name">
                                        ...
                                        @foreach ($managers as $manager) 
                                            <option value="{{$manager->id}}" {{ $games['manager_id'] === $manager->id ? 'selected' : '' }}>{{$manager->name}}  --
