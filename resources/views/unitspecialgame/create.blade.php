        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">            
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('unitspecial_game.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('special_game') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="special_game" type="text" class="form-control" name="special_game" value="{{ old('special_game') }}" required autofocus></textarea>
