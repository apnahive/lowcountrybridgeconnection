...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <a href="{{ route('unitspecial_game.create') }}" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add a New Special Game</button></a>
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <hr class="mobline">
                    @foreach ($special_game as $special_gamekey => $value) 
                    <div class="row" style="margin-top: 15px;display: flex;">
                        <!-- <div class="col-md-2 wcol-md-2">{{ $value->id }}</div> -->
                        <div class="col-md-8 wcol-md-8" style="word-wrap: break-word;">{{ $value->description }}</div>                        
                        <div class="col-md-3 wcol-md-3" style="text-align: center">
                            <div class="col-md-6"><a href="{{ route('unitspecial_game.edit', $value->id) }}"><button type="button" class="btn btn-priamry">Edit</button></a></div> 

                            <div class="col-md-6 button-top"> <button type="button" class="btn btn-priamry" data-toggle="modal" data-target="#confirm{{$value->id}}">Delete</button></div> 

                            <!-- <div class="col-md-4 button-top" style="text-align: center;"></div> -->
                            <form id="{{$value->id}}" action="/unitspecial_game/delete/{{$value->id}}" method="DELETE" style="display: none;">
