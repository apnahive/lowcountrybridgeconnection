            ...
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">                        
                            ...
                            <div class="col-md-4 wcol-md-4">{{ date('m-d-Y', strtotime($value->start_date)) }}</div>
                            <div class="col-md-3 wcol-md-3" style="text-align: center">
                                <div class="col-md-6">
                                    @if ($value->subscription_status)
                                    <p >
                                        @if ($value->end_date < $now->format("Y-m-d"))
                                         Ended
                                        @else
                                         Upcoming
                                        @endif
                                ...
                                <div class="col-md-6">
                                    @if ($value->subscription_status)
                                    <button type="button" class="btn btn-priamry"  data-toggle="modal" data-target="#confirm{{$value->id}}">Cancel</button>

                                    <form id="{{$value->id}}" action="{!! route('seriesenrolls', $value->id) !!}" method="POST" style="display: none;">
