...
<div class="container" style="margin-top: 60px;margin-bottom: 60px;">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="col-md-4"><a href="{{ route('playerunit.create') }}" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add New Unregistered User</button></a></div>
            </div>   -->                     
            ...
            <a href="{{ route('playerunit.show', 'upload-record') }}" class="pull-right" style="margin-bottom: 30px;">
