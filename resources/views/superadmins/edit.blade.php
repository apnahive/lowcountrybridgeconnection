                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
                              ...
                              <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
                                <div class="bhoechie-tab-content active">
                                  <div class="row">
                                     <div class="col-md-10">
                                        <form class="form-horizontal" role="form" method="POST" action="{!! route('superadmins.update', $superadmin->id) !!}">
                                            ...
                                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-8">
                                                    <input id="name" type="text" class="form-control" name="name" value="{{ old( 'name', $superadmin['name']) }}" required autofocus>
