...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <a href="{{ route('games.show', $id) }}" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">View Game</button></a>
                                        ...
                                        <div class="row" style="margin-top: 15px;display: flex;">
                                            ...
                                            <div class="col-md-4 wcol-md-4" style="text-align: center">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form id="{{$value->id}}" action="/playergame_cancel_enrollment/delete/{{ $value->id }}" method="DELETE" style="display: none;">
