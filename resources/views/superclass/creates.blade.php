        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">            
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('superclass.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('class_description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="class_description" type="text" class="form-control" name="class_description" value="{{ old('class_description') }}" placeholder="maximum 255 character" required autofocus></textarea>
                                    ...
                                    <select class="custom-select form-control" id="teacher_name" name="teacher_name">
                                      <option selected>Choose...</option>
                                        @foreach ( $teachers as $teacher ) 
                                            <h1><option value="{{ $teacher->id }}">{{ $teacher->name }}
                                            </option></h1>
                                        @endforeach                                      
                                    </select>
                                </div>
