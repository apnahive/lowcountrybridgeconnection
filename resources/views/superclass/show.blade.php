...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <form id="{{$classes->id}}" action="/superclass_subscription/delete/{{ $classes->id }}" method="DELETE" style="display: none;">
            ...
            @if($classes->class_status == 1)<a href="{{ route('superclass.edit', $classes->id) }}"><button type="button" class="btn btn-lg btn-info">Edit</button></a>
            <div class="pull-right">@endif
                <a href="{{ route('superplayers.create') }}"><button type="button" class="btn btn-lg btn-info">Add Student</button></a>
                <a href="{{ route('superclass_subscription.index') }}"><button type="button" class="btn btn-lg btn-info">Manage Enrollment</button></a>                
            </div>
        </div>
    </div>
</div>
