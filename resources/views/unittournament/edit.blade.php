        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                     ...
                     <form class="form-horizontal" role="form" method="POST" action="{!! route('unittournament.update', $tournaments['id']) !!}" enctype="multipart/form-data">
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content" style="text-align: left;">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{ route('unittournament.flyer', $tournaments['id']) }}"><button type="button" class="btn btn-primary" >Yes! Delete it</button></a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
