        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">            
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('unittournament.store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('tournament_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tournament_name" type="text" class="form-control" name="tournament_name" placeholder="maximum 455 character" value="{{ old('tournament_name') }}" required autofocus>
