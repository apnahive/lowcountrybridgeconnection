...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <a href="{{ route('unitclass.show', $id) }}" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">View Class</button></a>           
                        ...
                        @foreach ($users as $user)
                            @if($user->id == $value->user_id)                                
                                <div class="row" style="margin-top: 15px;display: flex;">
                                    ...
                                    <div class="col-md-3 wcol-md-3" style="text-align: center">
                                        <div class="col-md-6">
                                           <a href="{{ route('unitclasswaiting.edit', $value) }}"><button type="button" class="btn btn-priamry">Send Mail</button></a>
                                        </div>    
                                        <div class="col-md-6"></div>
                                    </div>
                                </div>
