...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <a href="{{ route('supergame.show', $id) }}" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">View Game</button></a>
           <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <hr class="mobline">
                    @foreach ($game_sub as $gamesubkey => $value)
                        @if ($value->game_id == $gameid)
                                        ...
                                        <div class="row" style="margin-top: 15px;display: flex;">
                                            ...
                                            <div class="col-md-4 wcol-md-4" style="text-align: center">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="button-top"><button type="button" class="btn btn-priamry" data-toggle="modal" data-target="#confirm{{$value->id}}">Cancel</button></div>

                                                    <form id="{{$value->id}}" action="/supergame_cancel_enrollment/delete/{{ $value->id }}" method="DELETE" style="display: none;">
