                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                              ...
                              <li class="page-scroll">
                                <a class="dropdown-toggle menudrop" data-toggle="dropdown" href="">Classes
                                  ...
                                  <ul class="dropdown-menu menudrop1">
                                    <li><a href="{{ route('classes.index') }}">Show Classes</a></li>
                                    <li><a href="{{ route('series.index') }}">Show Series</a></li>
                                    <li><a href="{{ route('series.create') }}">Create New Series</a></li>
                                    <li><a href="{{ route('classes.create') }}">Create New Class</a></li>
                                  </ul>
                              </li>
                              <li class="page-scroll">
                                <a href="{{ route('playerclass.index') }}">Manage Enrollments</a>
                              </li>
                              <li class="page-scroll">
                                <a href="{{ route('manage_students.index') }}">Manage Students</a>
                              </li>
                              <li class="page-scroll">
                                    <a href="{{ route('logout') }}"
                            ...
                            <ul class="nav navbar-nav navbar-right mobile" style="border: 2px white solid;border-bottom-width: 0;border-top-width: 0;">
                              ...
                              <li class="page-scroll">
                                <a href="{{ route('series.index') }}">Show Series</a>
                              </li>
                              <li class="page-scroll">
