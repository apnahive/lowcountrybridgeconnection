        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{!! route('superseries.update', $series['id']) !!}" enctype="multipart/form-data">
                                ...
                                <div class="form-group" style="margin: 0;">                                    
                                    <select class="custom-select form-control" id="teacher_name" name="teacher_name">
                                        ...
                                        @foreach ( $teachers as $teacher ) 
                                            <h1><option value="{{ $teacher->id }}" {{ $series['teacher_id'] === $teacher->id ? 'selected' : '' }}>{{ $teacher->name }}
                                            </option></h1>
                                        @endforeach                                      
                                    </select>
                                </div>
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content" style="text-align: left;">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{ route('superseries.flyer', $series['id']) }}"><button type="button" class="btn btn-primary" >Yes! Delete it</button></a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
