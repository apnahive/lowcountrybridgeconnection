        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                              ...
                              <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
                                <div class="bhoechie-tab-content active">
                                  <div class="row">
                                     <div class="col-md-12">
                                        <!-- add form here -->
                                        <form class="form-horizontal" role="form" method="POST" action="{!! route('superuserclass.update', $user['id']) !!}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <label for="class_name" class="control-label"> {{ $user->name }} </label>
                                                <label for="class_name" class="control-label"> {{ $user->lastname }} </label>
                                            </div>
                                        </div>
                    ...
                    <!-- <form class="form-horizontal" role="form" method="POST" action="{!! route('unituserclass.update', $user['id']) !!}">
                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
