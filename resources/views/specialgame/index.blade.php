...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <a href="{{ route('special_game.create') }}" class="pull-right"><button type="button" class="btn btn-lg btn-info pull-right">Add a New Special Game</button></a>
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <div class="col-md-3 wcol-md-3" style="text-align: center">
                            <div class="col-md-6"><a href="{{ route('special_game.edit', $value->id) }}"><button type="button" class="btn btn-priamry">Edit</button></a></div> 
                            ...
                            <form id="{{$value->id}}" action="/special_game/delete/{{$value->id}}" method="DELETE" style="display: none;">
