...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <form id="{{$classes->id}}" action="/unitclass_subscriptionss/delete/{{ $classes->id }}" method="DELETE" style="display: none;">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body" style="font-size: 19px;">               
                    ...
                    <div class="row" style="margin-bottom: 10px;display: flex;">
                        ...
                        <div class="col-md-6 wcol-md-6">{{ $classes->teacher }}</div>
                    </div>
                    <div class="row" style="margin-bottom: 10px;display: flex;">
            ...
            @if($classes->class_status == 1)<a href="{{ route('unitclass.edit', $classes->id) }}"><button type="button" class="btn btn-lg btn-info">Edit</button></a>@endif
            <div class="pull-right">
            <a href="{{ route('unitclasswaiting.show', $classes->id) }}"><button type="button" class="btn btn-lg btn-info">Waiting List</button></a>
                <a href="{{ route('unitclass_subscription.index') }}"><button type="button" class="btn btn-lg btn-info">Manage Enrollments </button></a>                
            </div>
        </div>
    </div>
</div>
