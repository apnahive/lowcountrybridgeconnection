...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <a href="{{ route('unitclass.index') }}"><button type="button" class="btn btn-lg btn-info">Back</button></a>            
            <div class="panel panel-default" style="margin-top: 30px;">
                <div class="panel-heading">Edit Class</div>
                <div class="panel-body">
               
                    <form class="form-horizontal" role="form" method="POST" action="{!! route('unitclass.update', $classes['id']) !!}"  enctype="multipart/form-data">
                                ...
                                <div class="form-group" style="margin: 0;">                                    
                                    <select class="custom-select form-control" id="teacher_name" name="teacher_name">
                                        ...
                                        @foreach ( $teachers as $teacher ) 
                                            <h1><option value="{{ $teacher->id }}" {{ $classes['teacher_id'] === $teacher->id ? 'selected' : '' }}>{{ $teacher->name }}
                                            </option></h1>
                                        @endforeach                                      
                                    </select>
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('class_from') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="class_from" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" name="class_from" value="{{ $classes['class_from'] }}">
                               <!-- <input id="class_from" type="date" class="form-control" name="class_from" value="{{ $classes['class_from'] }}"> -->
                        ...
                        <div class="form-group{{ $errors->has('class_flyer_address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <!-- <input id="class_flyer_address" type="text" class="form-control" name="class_flyer_address" value="{{ $classes['class_flyer_address'] }}" > -->
                                @if ($flyer)
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content" style="text-align: left;">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <a href="{{ route('unitclass.flyer', $classes['id']) }}"><button type="button" class="btn btn-primary" >Yes! Delete it</button></a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
