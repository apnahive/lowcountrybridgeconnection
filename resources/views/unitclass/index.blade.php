  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="{{ route('unitseries_class.editc', Session::get('error_codes')) }}"><button type="button" class="btn btn-primary">Yes</button></a>
...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default" style="margin-top: 30px;">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-top: 15px;display: flex;">
                        ...
                        <div class="col-md-5 wcol-md-5" style="text-align: center">                            
                            <div class="col-md-4 button-top"><a href="/unitclass/{{ $value->id }}"><button type="button" class="btn btn-priamry">View</button></a></div>
                            
                            <div class="col-md-4">@if($value->class_status == 1)<a href="{{ route('unitclass.edit', $value->id) }}"><button type="button" class="btn btn-priamry">Edit</button></a>@endif</div> 
                            ...
                            <form id="{{$value->id}}" action="/unitsclass/delete/{{$value->id}}" method="DELETE" style="display: none;">
            ...
            <!-- <a href="{{ route('class-files',['type'=>'xls']) }}" class="pull-right" style="margin-bottom: 30px;">
