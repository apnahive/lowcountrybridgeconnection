...
<div class="container" style="margin-top: 60px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="margin-bottom: 30px;">
            ...
            <form id="{{$games->id}}" action="/unitgame_subscriptionss/delete/{{ $games->id }}" method="DELETE" style="display: none;">
            ...
            @if($games->game_status == 1)<a href="{{ route('unitgame.edit', $games->id) }}"><button type="button" class="btn btn-lg btn-info">Edit</button></a>@endif
            <div class="pull-right">
               <a href="{{ route('unitgamewaiting.show', $games->id) }}"><button type="button" class="btn btn-lg btn-info">Waiting List</button></a>
