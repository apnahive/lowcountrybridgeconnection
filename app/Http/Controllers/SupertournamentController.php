...
class SupertournamentController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('supertournament.index', compact('tournaments'));
    }
    ...
    {
        return view('supertournament.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('supertournament.show', compact('tournaments', 'flyer'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('supertournament.edit', compact('tournaments', 'flyer'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('supertournament.index')->with('success','You have successfully deleted tournament');
    }
    public function delete_flyer($id)
    {
      ...
      //dd($file);
      $flyer->delete();
      return redirect()->route('supertournament.edit', $id)->with('success', 'You have successfully removed the Flyer');
