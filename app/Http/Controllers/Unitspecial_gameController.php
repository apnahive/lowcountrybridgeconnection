...
class Unitspecial_gameController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('unitspecialgame.index', compact('special_game'));
    }
    ...
    {
        return view('unitspecialgame.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('unitspecialgame.edit', compact('game'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('unitspecial_game.index')->with('success','You have successfully deleted special game');
    }
}
