...
class ClasswaitingController extends Controller
{
    /**
    ...
    public function show($id)
    {
        ...
        return view('classwait.show', compact('waiting', 'users', 'classes', 'id'));
    ...
    public function edit($id)
    {
        ...
        return redirect()->route('teacher.index')->with('success','You have successfully send the mail to the registered member.');      
    }
