...
class Unitseries_classController extends Controller
{
    /**
    ...
    public function editc($id)
    {
        ...
        //dd($classes, $series);
        return view('unitseriessub.editc', compact('classes', 'series'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('unitseriessub.edit', compact('classes', 'series'));
    }
