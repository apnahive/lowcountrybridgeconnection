...
class TournamentController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('tournament.show', compact('tournaments', 'flyer'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tournament.edit', compact('tournaments', 'flyer'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('tournament.index')->with('success','You have successfully deleted tournament');
    }
    ...
    public function delete_flyer($id)
    {
      ...
      //dd($file);
      $flyer->delete();
      return redirect()->route('tournament.edit', $id)->with('success', 'You have successfully removed the Flyer');
