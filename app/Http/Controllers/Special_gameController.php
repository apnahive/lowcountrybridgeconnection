...
class Special_gameController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('specialgame.index', compact('special_game'));
    }
    ...
    {
        return view('specialgame.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('specialgame.edit', compact('game'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('special_game.index')->with('success','You have successfully deleted special game');
    }
}
