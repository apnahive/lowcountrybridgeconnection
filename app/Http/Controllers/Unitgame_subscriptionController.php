...
class Unitgame_subscriptionController extends Controller
{
    /**
    ...
    public function index()
    {
        //
        //$id1 = Auth::id();
        $games = Game::where('game_status', '=', 1)->get();
        return view('unitgamesub.index', compact('games'));
    }
    ...
    public function create()
    {
        ...
        return view('unitgamesub.create', compact('players'), compact('games'));
    }
    public function create1()
    {
        ...
        $members = User::all();
        $games = Game::where('seats_available', '>=', 1)->where('game_status', '=', 1)->get();
        return view('unitgamesub.create1', compact('members'), compact('games'));
    }
    public function select()
    {
        return view('unitgamesub.inter');
    }
    ...
    public function store(Request $request)
    {
        ...
        $player_id = Game_subscription::where('user_id', '=', $playerid)->where('game_id', '=', $games->gameid)->where('is_member', '=', '0')->first(); 
      //  $class_subscription1 = Class_subscription::findOrFail($classid);
        if($player_id)
            {
                return redirect()->route('unitgame_subscription.create')->with('success','Player already enrolled in Game'); 
            }
        else{
        if($games->seats_available)
        {
            ...
            $game_sub->save();
            return redirect()->route('unitgame_subscription.index')->with('success','You have successfully enrolled the game'); 
        }
    }
    }
    ...
    public function store1(Request $request)
    {
        ...
        $games = Game::findOrFail($gameid);
        //$a = $classes->seats_booked;
        $member_id = Game_subscription::where('user_id', '=', $memberid)->where('game_id', '=', $games->gameid)->where('is_member', '=', '1')->first(); 
      //  $class_subscription1 = Class_subscription::findOrFail($classid);
        if($member_id)
            {
                return redirect()->route('unitgame_subscription.create1')->with('success','Player already enrolled in Game'); 
            }
        else{
        if($games->seats_available)
        {
            ...
            $game_sub->save();
            return redirect()->route('unitgame_subscription.index')->with('success','Member has successfully enrolled the class');
    ...
    public function show($id)
    {
        ...
        return view('unitgamesub.show', compact('game_sub', 'users', 'gameid', 'players', 'id'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('unitgamesub.edit', compact('players'), compact('games'));
    }
    ...
    public function update(Request $request, $id)
    {
        //dd(request()->all());
        $gameid = $request->game_name;
        if(Game_subscription::where('user_id', '=', $id)->where('game_id', '=', $gameid)->where('is_member', '=', 0)->exists())
        {
            return redirect()->route('unitgame_subscription.index')->with('info','You are already enrolled in the game');    
        }
        else
        {
            $games = Game::findOrFail($gameid);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('unitgame_subscription.index')->with('success','You have cancelled the game');
    }
    public function destroy1($id)
    {
        ...
        return redirect()->route('unitgame_subscription.index')->with('success','You have cancelled the enrollent');
