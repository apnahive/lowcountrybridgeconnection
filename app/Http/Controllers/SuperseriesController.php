...
class SuperseriesController extends Controller
{
    /**
    ...
    public function index()
    {
       ...
       return view('superseries.index', compact('series', 'teachers'));
    }
    ...
    public function create()
    {
        ...
        $clubs = Club::all();
        return view('superseries.create', compact('teachers', 'clubs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superseries.index')->with('error_code', $series->id);
    }
    ...
    public function show($id)
    {
        ...
        return view('superseries.show', compact('classes', 'series'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('superseries.edit', compact('series', 'teachers', 'clubs', 'flyer'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('superseries.index')->with('success','You have successfully updated the series');
    }
    ...
    public function destroy($id)
    {
        ...
        $series_sub->delete();
        return redirect()->route('superseries.index')->with('success','You have successfully deleted Series');
    }
    ...
    public function delete_flyer($id)
    {
      ...
      //dd($file);
      $flyer->delete();
      return redirect()->route('superseries.edit', $id)->with('success', 'You have successfully removed the Flyer');
