...
class Superclass_subscriptionController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('superclasssub.index', compact('classes'));
    }
    ...
    public function create()
    {
        ...
        return view('superclasssub.create', compact('players'), compact('classes'));
    }
    public function create1()
    {
        ...
        $members = User::all();
        $classes = Classroom::where('seats_available', '>=', 1)->where('class_status', '=', 1)->get();
        return view('superclasssub.create1', compact('members'), compact('classes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($classes->seats_available)
        {
            ...
            $class_sub->save();
            return redirect()->route('superclass_subscription.index')->with('success','You have sucessfully subscribed the class'); 
    ...
    public function store1(Request $request)
    {
        ...
        if($classes->seats_available)
        {
            ...
            $class_sub->save();
            return redirect()->route('superclass_subscription.index')->with('success','Member has sucessfully subscribed the class');
            //->with('success','You have sucessfully subscribed the class')
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('superclasssub.show', compact('class_sub', 'users', 'classid', 'players', 'id'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('superclasssub.edit', compact('players', 'series'), compact('classes'));
        //return view('superclasssub.edit', compact('players'), compact('classes'));
    }
    ...
    public function update(Request $request, $id)
    {
        if($request->class_name)
        {
            ...
            if($classes->seats_available)
            {
                ...
                $class_sub->save();
                return redirect()->route('superclass_subscription.index')->with('success','You have sucessfully enrolled the class'); 
                //->with('success','You have sucessfully subscribed the class')
            }
        }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('superclass_subscription.index')->with('success','You have cancelled the class');
    ...
    public function destroy1($id)
    {
        ...
        return redirect()->route('superclass_subscription.index')->with('success','You have cancelled the enrollment');
