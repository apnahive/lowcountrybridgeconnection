...
class Playerclass_subscriptionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('playerclass.index', compact('classes'));
    }
    ...
    public function create()
    {
        ...
        $id1 = Auth::id();
        $players = Player::all();
        $classes = Classroom::where('teacher_id', '=', $id1)->where('class_status', '=', 1)->where('seats_available', '>=', 1)->get();
        return view('playerclass.create', compact('players'), compact('classes'));
    }
    public function create1()
    {
        ...
        $members = User::all();
        $classes = Classroom::where('teacher_id', '=', $id1)->where('class_status', '=', 1)->where('seats_available', '>=', 1)->get();
        return view('playerclass.create1', compact('members'), compact('classes'));
    }
    public function select()
    {
        return view('playerclass.inter');
    }
    /**
    ...
    public function store(Request $request)
    {
        ...
        if($classes->seats_available)
        {
            ...
            $class_sub->save();
            return redirect()->route('manage_students.index')->with('success','You have successfully enrolled the class'); 
    ...
    public function store1(Request $request)
    {
        ...
        if($classes->seats_available)
        {
            ...
            $class_sub->save();
            return redirect()->route('playerclass.index')->with('success','Member has successfully enrolled the class');
            //->with('success','You have sucessfully subscribed the class')
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('playerclass.show', compact('class_sub', 'users', 'classid', 'players', 'id'));
    }
    ...
    public function edit($id)
    {
        ...
        $id1 = Auth::id();
         ...
         $classes = Classroom::where('teacher_id', '=', $id1)->where('class_status', '=', 1)->where('seats_available', '>=', 1)->get();
         $series = Class_series::where('teacher_id', '=', $id1)->select('id', 'name')->get();
         return view('playerclass.edit', compact('players'), compact('classes', 'series')); 
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        {
            //dd("Series selected");
            /*$test = Series_subscription::where('user_id', '=', 22)->where('series_id', '=', 9)->where('is_member', '=', 1)->get();
            dd($test);*/
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('teacher.index')->with('success','You have cancelled the class');
    ...
    public function destroy1($id)
    {
        ...
        return redirect()->route('playerclass.index')->with('success','You have cancelled the enrollment');
