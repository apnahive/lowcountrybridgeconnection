...
class SuperclasswaitController extends Controller
{
    /**
    ...
    public function show($id)
    {
        ...
        return view('superclasswait.show', compact('waiting', 'users', 'classes', 'id'));
    }
    ...
    public function edit($id)
    {
        ...
        return redirect()->route('superadmins.index')->with('success','You have successfully send the mail to the registered member.');   
    }
