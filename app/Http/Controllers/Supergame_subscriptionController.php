...
class Supergame_subscriptionController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('supergamesub.index', compact('games'));
    }
    ...
    public function create()
    {
        ...
        return view('supergamesub.create', compact('players'), compact('games'));
    }
    public function create1()
    {
        ...
        $members = User::all();
        $games = Game::where('seats_available', '>=', 1)->where('game_status', '=', 1)->get();
        return view('supergamesub.create1', compact('members'), compact('games'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($games->seats_available)
        {
            ...
            $game_sub->save();
            return redirect()->route('supergame_subscription.index')->with('success','You have successfully subscribed the game'); 
        }
    }
    ...
    public function store1(Request $request)
    {
        ...
        if($games->seats_available)
        {
            ...
            $game_sub->save();
            return redirect()->route('supergame_subscription.index')->with('success','Member has successfully subscribed the class');
    ...
    public function show($id)
    {
        ...
        return view('supergamesub.show', compact('game_sub', 'users', 'gameid', 'players', 'id'));
    }
    ...
    public function edit($id)
    {
        ...
        $games = Game::where('seats_available', '>=', 1)->where('game_status', '=', 1)->get();
        return view('supergamesub.edit', compact('players'), compact('games'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        {
            return redirect()->route('supergame_subscription.index')->with('info','You are already enrolled in the game');    
        ...
        else
        {
            ...
            if($games->seats_available)
            {
                ...
                $game_sub->save();
                return redirect()->route('supergame_subscription.index')->with('success','You have successfully enrolled the game'); 
                //->with('success','You have sucessfully subscribed the class')
            }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('supergame_subscription.index')->with('success','You have cancelled the game');
    }
    public function destroy1($id)
    {
        ...
        return redirect()->route('supergame_subscription.index')->with('success','You have cancelled the enrollent');
