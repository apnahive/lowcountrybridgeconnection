...
class Class_seriesController extends Controller
{
    /**
    ...
    {
        $clubs = Club::all();
        return view('series.create', compact('clubs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //dd($series->id);
        //$series = Class_series::where('teacher_id', '=', $id1)->get();
        //return View::make('series.index')->with(['series' => $series, 'error_code', 5]);
        //return Redirect::route('series.index')->with('error_code', 5);
        return redirect()->route('series.index')->with('error_code', $series->id);
    }
    ...
    public function show($id)
    {
        ...
        return view('series.show', compact('classes', 'series'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('series.edit', compact('series', 'clubs', 'flyer'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('series.index')->with('success','You have successfully updated the series');
    }
    ...
    public function destroy($id)
    {
        ...
        $series_sub->delete();
        return redirect()->route('series.index')->with('success','You have successfully deleted Series');
    }
    ...
    public function delete_flyer($id)
    {
      ...
      //dd($file);
      $flyer->delete();
      return redirect()->route('series.edit', $id)->with('success', 'You have successfully removed the Flyer');
